...
const galleryData = [
  { id: 1, src: '/use-assets/1.jpg', category: 'Temple', title: 'Jambudweep Main Entrance', desc: 'The grand entrance to the 30-acre spiritual campus of Jambudweep.' },
  { id: 2, src: '/use-assets/2.jpg', category: 'Temple', title: 'Shri Digambar Jain Temple', desc: 'Detailed stone carvings representing the eternal heritage of Jainism.' },
  ...
  { id: 4, src: '/use-assets/4.jpg', category: 'Spiritual', title: 'Devotional Assembly', desc: 'A gathering of devotees engaged in deep prayer and meditation.' },
  { id: 5, src: '/use-assets/5.jpg', category: 'Temple', title: 'Carved Ceilings', desc: 'Intricate marble work adorning the main temple ceilings.' },
  { id: 6, src: '/use-assets/6.jpg', category: 'Spiritual', title: 'Daily Rituals', desc: 'Sacred ceremonies performed by the temple priests in Hastinapur.' },
  { id: 7, src: '/use-assets/7.jpg', category: 'Events', title: 'Festival Celebration', desc: 'Joyous moments during the annual religious festivals at Jambudweep.' },
  ...
  { id: 9, src: '/use-assets/9.jpg', category: 'Temple', title: 'Temple Spire', desc: 'The towering shikhara reaching towards the heavens.' },
  { id: 10, src: '/use-assets/10.jpg', category: 'Spiritual', title: 'Guru Blessings', desc: 'Devotees receiving wisdom and blessings from Ganinipramukh Shri Gyanmati Mataji.' },
  { id: 11, src: '/use-assets/11.jpg', category: 'Temple', title: 'Lotus Temple (Kamal Mandir)', desc: 'A stunning architectural symbol of purity, shaped like a blooming lotus.' },
  { id: 12, src: '/use-assets/12.jpg', category: 'Temple', title: 'Meditation Temple', desc: 'A serene grass-covered dome designed for deep contemplation.' },
  { id: 13, src: '/use-assets/13.jpg', category: 'Temple', title: 'Navgrah Jinayalaya', desc: 'The sacred temple dedicated to the nine celestial bodies.' },
  ...
  { id: 17, src: '/use-assets/17.jpg', category: 'Campus', title: 'Trilok Shodh Sansthan', desc: 'The administrative and research hub of the institute.' },
  ...
  { id: 19, src: '/use-assets/19.jpg', category: 'Temple', title: 'Symmetrical Beauty', desc: 'Perfect balance in modern Jain temple design.' },
  ...
  { id: 22, src: '/use-assets/22.jpg', category: 'Temple', title: 'Statue of Ahimsa', desc: 'The world\'s tallest single-stone statue of Lord Rishabhdev at Mangi-Tungi (Associated).' },
  ...
  { id: 26, src: '/use-assets/gallery-user/1.webp', category: 'Temple', title: 'Temple Entrance', desc: 'The majestic entrance gateway of the Jambudweep complex.' },
  { id: 27, src: '/use-assets/gallery-user/2.webp', category: 'Temple', title: 'Main Temple Facade', desc: 'Beautifully carved stone facade showcasing intricate Jain architecture.' },
  ...
  { id: 29, src: '/use-assets/gallery-user/4.webp', category: 'Temple', title: 'Statue view', desc: 'The monumental world-record statue of Lord Rishabhdev.' },
  ...
  { id: 33, src: '/use-assets/airavat_elephant_clean.png', category: 'Campus', title: 'Airavat Elephant', desc: 'The grand statue of the divine elephant Airavat.' },
  { id: 34, src: '/use-assets/kalam_interaction.png', category: 'Events', title: 'Historical Visit', desc: 'Former President Dr. APJ Abdul Kalam visiting Jambudweep.' },
  { id: 35, src: '/use-assets/library.png', category: 'Campus', title: 'Jain Library', desc: 'A vast collection of ancient scriptures and research materials.' },
  { id: 36, src: '/use-assets/namokar_bank.png', category: 'Spiritual', title: 'Namokar Bank', desc: 'A unique spiritual bank for writing and storing Namokar Mantras.' },
  { id: 37, src: '/use-assets/nauka_vihar_clean.png', category: 'Campus', title: 'Nauka Vihar', desc: 'Traditional boating experience in the sacred rivers of the model.' },
  { id: 38, src: '/use-assets/pravachan_hall.png', category: 'Temple', title: 'Pravachan Hall', desc: 'The grand hall for spiritual discourses and lectures.' }
];
